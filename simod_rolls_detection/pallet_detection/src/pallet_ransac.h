...
class PalletRansac
{
  ...
  PalletRansac(const double pallet_convergence_threshold,
  ...
  double NormalDistance(const Eigen::Vector3d & n1, const Eigen::Vector3d & n2, const double max_angle);
  double PlanesDistance(const Eigen::Vector4d & p1, const Eigen::Vector4d & p2, const double max_angle, const double max_distance);
